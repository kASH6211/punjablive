...
<aside class="w-72" aria-label="Sidebar">
    <div class="min-h-screen h-full overflow-y-auto bg-gray-50 shadow-2xl dark:bg-gray-800">
        <div class="h-16 bg-blue-900 mb-5 flex justify-center items-center">
        ...
        <div class="pl-2 mt-14">
            ...
            <div class="flex flex-col pb-5 pl-4">
                ...
                <div class="rounded-full w-16 h-16 bg-gradient-to-bl from-blue-900 to-blue-900 via-blue-700 mb-1 flex  justify-center items-center">
                    @php
        ...
        <ul class="space-y pl-2">
            <li>
                ...
                <x-nav-link class="text-sm border-b border-gray-200 uppercase" href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
            ...
            <li>
                ...
                <x-nav-link class="border-b text-sm border-gray-200 uppercase" href="{{ route('adminusers') }}" :active="request()->routeIs('adminusers')">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="mr-2 w-6 h-6">
                ...
                <ul id="dropdown-example2" class="hidden">
                    <li>
                        <div class="pl-6">
                            ...
                            <x-nav-link class="uppercase  text-sm border-b border-gray-200" href="{{ '#' }}">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="mr-2 w-6 h-6">
                    ...
                    <li>
                        <div class="pl-6">
                            ...
                            <x-nav-link class="uppercase  text-sm border-b border-gray-200" href="{{ '#'}}" :active="request()->routeIs('project-privileges')">
            ...
            <li>
                ...
                {{-- <x-nav-link class="uppercase  text-sm border-b border-gray-200" href="{{ route('projects') }}" :active="request()->routeIs('projects')">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="mr-2 w-6 h-6">
            ...
            <li>
                ...
                <x-nav-link class="border-b text-sm border-gray-200 uppercase" href="{{ '#' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="mr-2 w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z" />
                    </svg>
                ...
                <ul id="dropdown-example3" class="hidden">
                    ...
                    <li>
                        <div class="pl-6">
                            ...
                            <x-nav-link class="uppercase  text-sm border-b border-gray-200" href="{{ route('adminprojects') }}" :active="request()->routeIs('adminprojects')">
                    ...
                    <li>
                        <div class="pl-6">
                            ...
                            <x-nav-link class="uppercase  text-sm border-b border-gray-200" href="{{ route('rolebasedprojects',[$ar]) }}" :active="request()->routeIs('adminprojects')">
                    ...
                    <li>
                        <div class="pl-6">
                            ...
                            <x-nav-link class="uppercase  text-sm border-b border-gray-200" href="{{ route('createproject') }}" :active="request()->routeIs('createproject')">
    ...
    <li>
        <div class="pl-6">
            ...
            <x-nav-link class="uppercase  text-sm border-b border-gray-200" href="{{ route('categories') }}" :active="request()->routeIs('categories')">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="mr-2 w-6 h-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9.568 3H5.25A2.25 2.25 0 003 5.25v4.318c0 .597.237 1.17.659 1.591l9.581 9.581c.699.699 1.78.872 2.607.33a18.095 18.095 0 005.223-5.223c.542-.827.369-1.908-.33-2.607L11.16 3.66A2.25 2.25 0 009.568 3z" />
                    <path stroke-linecap="round" stroke-linejoin="round" d="M6 6h.008v.008H6V6z" />
                </svg>
        ...
        <ul id="dropdown-example" class="hidden">
            <li>
                <div class="pl-6">
                    ...
                    <x-nav-link class="uppercase  text-sm border-b border-gray-200" href="{{ route('team') }}" :active="request()->routeIs('team')">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="mr-2 w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M9.568 3H5.25A2.25 2.25 0 003 5.25v4.318c0 .597.237 1.17.659 1.591l9.581 9.581c.699.699 1.78.872 2.607.33a18.095 18.095 0 005.223-5.223c.542-.827.369-1.908-.33-2.607L11.16 3.66A2.25 2.25 0 009.568 3z" />
                            <path stroke-linecap="round" stroke-linejoin="round" d="M6 6h.008v.008H6V6z" />
                        </svg>
    ...
    <li>
        ...
        <x-nav-link class="border-b text-sm border-gray-200 uppercase" href="{{ route('team') }}" :active="request()->routeIs('team')">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="mr-2 w-6 h-6">
