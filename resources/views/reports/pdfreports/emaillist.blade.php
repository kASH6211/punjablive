...
<body>
  <div id="title" class="text-center font-bold text-lg py-2">LIST OF OFFICES FROM DISTRICT <span>{{strtoupper(Auth::user()->userdistrict->DistName)}}</span></div>
   
     <div  id="title" class="text-center font-bold p-1"> Total Emails : {{count($data)}}</div>
