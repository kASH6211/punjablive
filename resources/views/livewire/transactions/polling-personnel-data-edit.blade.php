    ...
    <div class="rounded-b-md mb-4 bg-blue-900/5 border-blue-900/30  border border-t-0 border-dashed ">
        <div class="grid grid-cols-3 p-4 py-8 gap-4">
            ...
            <div class="w-full">
                ...
                @if($object && $object->hrmsdata && $object->hrmsdata ==1)
                <x-input wire:model.defer="object.hrmscode" class="block w-full cursor-not-allowed" type="text" :value="old('ddocode')" required readonly />
                @else
    ...
    <div class="rounded-b-md mb-4 bg-blue-900/5 border-blue-900/30  border border-t-0 border-dashed ">
        <div class="grid grid-cols-3 p-4 py-8 gap-4">
            <div class="w-full">
                ...
                {{-- <x-select wire:model.lazy="object.nativecon" type="text" class="" :ddlist="$conslist" idfield="AC_NO" textfield="AC_NAME" /> --}}
                <select wire:model.defer="object.nativecon" type="text" class="border-0 form-select block w-full text-gray-500 focus:border-blue-100 focus:ring focus:ring-blue-100 focus:ring-opacity-50 rounded-sm shadow-sm">
            ...
            <div class="w-full">
                ...
                {{-- <x-select wire:model.lazy="object.HomeCons" type="text" class="block w-full" :ddlist="$conslist" idfield="AC_NO" textfield="AC_NAME" /> --}}
                <select wire:model.defer="object.HomeCons" type="text" class="border-0 form-select block w-full text-gray-500 focus:border-blue-100 focus:ring focus:ring-blue-100 focus:ring-opacity-50 rounded-sm shadow-sm">
                    <option value="-1">Select Option</option>
                    @foreach ($conslist as $item)
                    <option class="border-0 border-purple-100 leading-loose" value={{$item['AC_NO']}}>{{$item['AC_NAME']}}</option>
                    @endforeach
            ...
            <div class="w-full">
                ...
                {{-- <x-select wire:model.lazy="object.cons" type="text" class="block w-full" :ddlist="$conslist" idfield="AC_NO" textfield="AC_NAME" /> --}}
            ...
            <div class="w-full">
                ...
                <x-input wire:model.defer="object.epicno" class="block w-full" type="text" :value="old('office')" required />
            </div>
            ...
            <div class="w-full">
                ...
                <select wire:model.defer="object.RegdVoterCons" type="text" class="border-0  form-select block w-full text-gray-500 focus:border-blue-100 focus:ring focus:ring-blue-100 focus:ring-opacity-50 rounded-sm shadow-sm">
                    <option value="-1">Select Option</option>
                    @foreach ($conslist as $item)
                    <option class="border-0 border-purple-100 leading-loose" value={{$item['AC_NO']}}>{{$item['AC_NAME']}}</option>
                    @endforeach
...
<div class="p-2 bg-blue-900/20 rounded-t-md text-blue-900 ">Duty performed in Previous Elections</div>
<div class="rounded-b-md mb-4 bg-blue-900/5 border-blue-900/30  border border-t-0 border-dashed ">
    <div class="grid grid-cols-3 p-4 py-8 gap-4">
...
<div class="p-2 bg-blue-900/20 rounded-t-md text-blue-900 ">Current Election Duty</div>
<div class="rounded-b-md mb-4 bg-blue-900/5 border-blue-900/30  border border-t-0 border-dashed ">
    <div class="grid grid-cols-3 p-4 py-8 gap-4">
        ...
        <div class="w-full">
            ...
            <div class="flex">
                <x-label for="name" value="{{ __('Current Status') }}" />
                <span class="text-red-500 ml-1">*</span>
            </div>
            <x-select wire:model.defer="object.transferred" wire:change="workstatuschange" type="text" class="block w-full" :ddlist="$status" idfield="id" textfield="description" />
...
<div class="flex justify-center items-center p-4 rounded-md ">
    <x-primary-button wire:click="addpdobject()" wire:key="up{{ $object->id}}">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 mr-2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M19 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zM4 19.235v-.11a6.375 6.375 0 0112.75 0v.109A12.318 12.318 0 0110.374 21c-2.331 0-4.512-.645-6.374-1.766z" />
        </svg>
        Update Employee Details</x-primary-button>
