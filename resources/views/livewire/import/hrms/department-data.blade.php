...
<div class="mt-4 w-full">
    <x-label for="name" value="{{ __('Upload Department File (.xls or .xlsx)') }}" />
</div>
...
<div class="w-full mt-4 border border-dashed rounded-md border-gray-300 p-4">
   ...
   <h1><span class="text-gray-700 font-semibold">Summary:</span>{{ $count }} departments are successfully mapped</h1>
